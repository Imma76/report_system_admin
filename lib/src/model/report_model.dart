class Reports{
  ...
  Reports({this.audioUrls,this.reportId,this.fcmToken,this.isAnonymous,this.userId,this.email,this.imageUrls,this.name,this.regNo,this.report,this.videoUrls,this.createdAt, this.reportStatus});
